    ...
    class ServicosData : Conexao
    {
        ...
        public bool Inserir(Servicos servico)
        {
            ...
            try
            {
                ...
                Cmd.Connection = Cnn;
                Cmd.CommandText = 
                    @"insert into servicos values (@valor, @descricao, @staus);";
        ...
        public bool Editar(Servicos servico)
        {
            ...
            try
            {
                ...
                Cmd.CommandText =
                    @"update servicos set valor = @valor, descricao = @descricao where id = @id;";
        ...
        public Servicos Obtem(int id)
        {
            ...
            try
            {
                ...
                if (Dr.Read())
                {
                    ...
                    servico.Valor = Dr.GetDecimal(1);
                    servico.Descricao = Dr.GetString(2);
