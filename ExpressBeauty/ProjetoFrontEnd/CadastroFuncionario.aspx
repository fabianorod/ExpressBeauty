<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaPrincipal.Master" AutoEventWireup="true" CodeBehind="CadastroFuncionario.aspx.cs" Inherits="ProjetoFrontEnd.CadastroFuncionario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <form class="form-horizontal">
            ...
            <div class="form-group"> 
                    <asp:label runat="server" for="lblcpf" class="col-md-2 control-label">Cpf:</asp:label>
                    <div class="col-md-10">
            ...
            <div class="form-group"> 
             ...
             <div class="form-group"> 
                    <asp:label runat="server" for="lbltelefonea" class="col-md-2 control-label">Telefone Alternativo:</asp:label>
                    <div class="col-md-10">
            ...
            <div class="form-group"> 
                    <asp:label runat="server" for="lblsalario" class="col-md-2 control-label">Salário:</asp:label>
                    <div class="col-md-10">
            ...
            <div class="form-group"> 
                    <asp:label runat="server" for="lblhorario" class="col-md-2 control-label">Horário:</asp:label>
                    <div class="col-md-10">
            ...
            <div class="form-group">
                ...
                <div class="form-group"> 
                    <div class="col-md-offset-2 col-md-10">
                        <asp:button runat="server" type="submit" class="btn btn-default" Text="Salvar" OnClick="btnSalvar_Click"/>
