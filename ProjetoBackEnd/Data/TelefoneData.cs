    ...
    class TelefoneData : Conexao
    {
        ...
        public bool Inserir(Telefone telefone)
        {
            ...
            try
            {
                ...
                Cmd.Parameters.AddWithValue("@pessoa_id", telefone.Pessoa.Id);
        ...
        public bool Editar(Telefone telefone)
        {
            ...
            try
            {
                ...
                Cmd.CommandText =
                    @"update telefones set numero = @numero, tipo = @tipo where pessoa_id = @pessoa_id";
        ...
        public List<Telefone> ListarPorPessoa(int idPessoa)
        {
            List<Telefone> lista = null;
            PessoaData pessoaData = new PessoaData(strCnn);
            ...
            try
            {
                ...
                Cmd.CommandText =
                    @"select * from telefones where pessoa_id = " + idPessoa;
