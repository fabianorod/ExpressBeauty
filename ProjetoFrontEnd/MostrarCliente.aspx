...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <div class="form-group"> 
            ...
            <div class="form-group"> 
                    <asp:label runat="server" id="status" class="col-md-2 control-label">Status:</asp:label>
                <div class="form-group">
                    <asp:label runat="server" id="lblstatus" class="col-md-10 control-label"></asp:label>
                    </div>
                </div>
