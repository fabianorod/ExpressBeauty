<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/PaginaPrincipal.Master" AutoEventWireup="true" CodeBehind="CadastroCliente.aspx.cs" Inherits="ProjetoFrontEnd.WebForm1" %>
        ...
        <form class="form-horizontal">
            ...
            <div class="form-group"> 
                    ...
                    <div class="col-md-10">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txtcpf"   runat="server" ErrorMessage="Field Social Security Number required" ForeColor="#FF3300">*Field Social Security required</asp:RequiredFieldValidator>
                    </div>
                </div>
                ...
                <div class="form-group"> 
                    ...
                    <div class="col-md-10">
                        <asp:textbox runat="server" type="text" class="form-control" id="txttelefonea"
                                placeholder="Type an alternative phone"/>
                        <br />
                    </div>
                </div>
            ...
            <div class="form-group"> 
                    ...
                    <div class="col-md-10">
                        <asp:textbox runat="server" type="password" class="form-control" id="txtsenhac" placeholder="Type confirm your password"/>
                        <br />
                    </div>
                </div>
            ...
            <br />
                <div class="form-group"> 
                    <div class="col-md-offset-2 col-md-10">
                        <asp:button runat="server" type="submit" class="btn btn-success" Text="Save" ID="btnSalvarCliente" CausesValidatein="true" OnClick="btnSalvarCliente_Click"/>
                        <asp:button runat="server" type="reset" class="btn btn-danger" Text="Cancel" ID="btnCancelarCliente" CausesValidation="false"/>
                    </div>
                </div>
            </form>
        </div>
